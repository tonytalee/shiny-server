...
withBusyIndicatorUI <- function(button) {
    ...
    div(
        ...
        span(
            ...
            hidden(
                img(src = "www/loading_circle.gif", class = "btn-loading-indicator"),
...
# HTML style =============================================================================
inlinestyle <- function(width= 300, v_align= "middle") {
    paste0("display: inline-block; vertical-align:", v_align, "; width:", width, "px;")
}
